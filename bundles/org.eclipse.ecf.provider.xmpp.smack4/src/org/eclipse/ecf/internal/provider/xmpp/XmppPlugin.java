...
public class XmppPlugin implements BundleActivator {
	...
	private Map<IPresenceService, ServiceRegistration<IPresenceService>> presenceServices;

	private ServiceTracker<IAdapterManager, IAdapterManager> adapterManagerTracker = null;
	...
	public IAdapterManager getAdapterManager() {
		...
		if (adapterManagerTracker == null) {
			adapterManagerTracker = new ServiceTracker<IAdapterManager, IAdapterManager>(this.context,
	...
	protected LogService getLogService() {
		if (logServiceTracker == null) {
			logServiceTracker = new ServiceTracker<LogService, LogService>(this.context, LogService.class.getName(),
					null);
	...
	public void start(BundleContext context) throws Exception {
		...
		presenceServices = new HashMap<IPresenceService, ServiceRegistration<IPresenceService>>();
	}
	...
	public void registerService(IPresenceService service) {
		if (context != null)
			presenceServices.put(service, context.registerService(IPresenceService.class, service, null));
	}

	public void unregisterService(IPresenceService service) {
		final ServiceRegistration<IPresenceService> registration = presenceServices.remove(service);
